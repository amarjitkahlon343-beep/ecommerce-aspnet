<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blank.aspx.cs" Inherits="Ecomwebsite.Admin.blank" %>
                 ...
                 <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown no-arrow mx-1">
                         ...
                         <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                             ...
                             <a class="dropdown-item d-flex align-items-center" href="#">
                                 <div class="dropdown-list-image mr-3">
                                     <img class="rounded-circle" src="../AdminTemplate/img/undraw_profile.svg"
                                         alt="..."/>
                                     <div class="status-indicator bg-success">Welcome</div>
                                 </div>
                                 <div>
