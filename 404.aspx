<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="404.aspx.cs" Inherits="Ecomwebsite.Admin._404" %>
...
<body>
 ...
 <div id="wrapper">
     ...
     <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <!-- Nav Item - Dashboard -->
         <li class="nav-item">
             <a class="nav-link" href="Dashboardaspx.aspx">
         ...
         <li class="nav-item active">
             ...
             <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                 ...
                 <div class="bg-white py-2 collapse-inner rounded">
                     ...
                     <a class="collapse-item" href="Forget Pass.aspx">Forgot Password</a>
         ...
         <div id="content">
                 ...
                 <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown no-arrow">
                         <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <span class="mr-2 d-none d-lg-inline text-gray-600 small">oops</span>
             ...
             <div class="container-fluid">
                 ...
                 <div class="text-center">
                     ...
                     <a href="Dashboardaspx.aspx">&larr; Back to Dashboard</a>
                 </div>
         ...
         <footer class="sticky-footer bg-white">
             <div class="container my-auto">
                 <div class="copyright text-center my-auto">
                     <span>Copyright &copy; kahlon Website 2020</span>
                 </div>
             </div>
         </footer>
         <!-- End of Footer -->
